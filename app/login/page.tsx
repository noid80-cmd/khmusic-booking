      ...
      <div className="w-full max-w-sm flex flex-col items-center" style={{ marginBottom: '10vh' }}>
        ...
        <div className="w-full flex flex-col gap-5">
          ...
          <button onClick={handleGoogle}
            className="w-full flex items-center justify-center gap-3 font-bold py-5 rounded-2xl transition active:scale-95"
            style={{ background: '#ffffff', color: '#1e1b4b', fontSize: 17, border: '1px solid #d8d8ec', boxShadow: '0 2px 12px rgba(0,0,0,0.08)' }}>
          ...
          {!resetMode ? (
            <form onSubmit={handleLogin} className="flex flex-col gap-4">
              ...
              <button type="submit" disabled={loading}
                className="w-full py-5 rounded-2xl text-white font-bold text-[17px] disabled:opacity-50 transition active:scale-95 mt-1"
